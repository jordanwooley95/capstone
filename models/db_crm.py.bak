...
db.define_table(
    "states",
    Field("select_state", requires=IS_IN_SET(sorted(["Colorado", "Washington", "Alaska", "Oregon", "Washington D.C.", "California", "Maine", "Massachusetts", "Nevada", "Michigan", "Vermont", "Illinois", "Arizona", "Montana", "New Jersey", "New York", "Virginia", "New Mexico", "Connecticut", "Rhode Island", "Maryland", "Missouri", "Delaware", "Minnesota", "Ohio"]))),
...
db.define_table(
    ...
    Field("select_state", "reference states"),
